 ...
 * {@link SetLabelsDescriptor#newInstance(StaplerRequest)} is invoked
 * and a new {@link SetLabels} is created. The created
 ...
 * @author Arun Suresh
 */
public class SetLabels extends ManageSlaveBuildStep {
    ...
    public SetLabels(String slaveName, String labels) {
    ...
    /**
     * Descriptor for {@link SetLabels}. Used as a singleton.
     * The class is marked as public so that it can be accessed from views.
     */
    @Extension // This indicates to Jenkins that this is an implementation of an extension point.
    public static final class SetLabelsDescriptor extends ManageSlaveBuildStepDescriptor {
        /**
